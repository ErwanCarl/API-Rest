 ...
 */
final class Version20230407095413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, marketplace_id INT NOT NULL, name VARCHAR(50) NOT NULL, nickname VARCHAR(50) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, account_key VARCHAR(255) DEFAULT NULL, INDEX IDX_81398E097078ABE4 (marketplace_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE phone (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, brand VARCHAR(50) NOT NULL, price DOUBLE PRECISION NOT NULL, os VARCHAR(50) NOT NULL, cpu VARCHAR(255) NOT NULL, screen VARCHAR(255) DEFAULT NULL, is_available TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
